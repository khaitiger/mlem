! function (t, e) {
  ...
  if ("object" == typeof i) {
    ...
    for (var a in i) n[0] && (n[0][a] = i[a]), n[1] && "__esModule" !== a && (n[1][a] = i[a]), n[2] && (n[2][a] = i[a])
  }
}(this, function () {
  return function (t) {
    var e = {};
      ...
      a = function () {
        return function () {
          return function t(e, i, a) {
            ...
            for (var r = "function" == typeof n && n, s = 0; s < a.length; s++) o(a[s]);
            return o
          }
        }()({
          1: [function (t, e, i) {}, {}],
                ...
                calculateBarIndexPixels: function (t, e, i) {
                  var n = i.scale.options,
                    a = "flex" === n.barThickness ? function (t, e, i) {
                      ...
                      return null === r && (r = o - (null === s ? e.end - o : s - o)), null === s && (s = o + o - r), n = o - (o - r) / 2 * l, {
                      ...
                      var n, a, r = i.barThickness,
                        s = e.stackCount,
                        l = e.pixels[t];
                      return o.isNullOrUndef(r) ? (n = e.min * i.categoryPercentage, a = i.barPercentage) : (n = r * s, a = 1), {
                        chunk: n / s,
                        ratio: a,
                        start: l - n / 2
                      }
                    ...
                    l = Math.min(o.valueOrDefault(n.maxBarThickness, 1 / 0), a.chunk * a.ratio);
                  return {
                    base: s - l / 2,
                    head: s + l / 2,
                    center: s,
              ...
              t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                construct: function (e, i) {
                  ...
                  var r = s.acquireContext(e, i),
                    ...
                    u = l && l.height,
                    d = l && l.width;
                  o.id = a.uid(), o.ctx = r, o.canvas = l, o.config = i, o.width = d, o.height = u, o.aspectRatio = u ? d / u : null, o.options = i.options, o._bufferedRender = !1, o.chart = o, o.controller = o, t.instances[o.id] = o, Object.defineProperty(o, "data", {
                    get: function () {
                  ...
                  }), r && l ? (o.initialize(), o.update()) : console.error("Failed to create chart: can't acquire context from the given item")
                },
                initialize: function () {
                  var t = this;
              ...
              update: function (t, e, i) {
                if (t) {
                  ...
                  n.each(g.concat(p), function (t) {
                    ...
                    if (t.getPadding) {
                      var e = t.getPadding();
                      D = Math.max(D, e.top), P = Math.max(P, e.bottom)
                    }
                  });
                  var I = l,
                    A = u,
                  ...
                  }), I = l, A = u, T = d, F = c, n.each(h, function (t) {
                    I += t.width
                  }), n.each(f, function (t) {
                    A += t.width
                  }), n.each(g, function (t) {
                ...
                function V(t) {
                  t.isHorizontal() ? (t.left = t.fullWidth ? l : I, t.right = t.fullWidth ? e - u : I + w, t.top = W, t.bottom = W + t.height, W = t.bottom) : (t.left = B, t.right = B + t.width, t.top = T, t.bottom = T + M, B = t.right)
                }
              }
            }
          }, {
                ...
                draw: function (t) {
                  ...
                  if (a.display) {
                    var s = e.ctx,
                      ...
                      P = "right" === a.position ? e.right : e.right - D - k,
                    ...
                    if (o.each(m, function (i, n) {
                        if (!o.isNullOrUndef(i.label)) {
                          ...
                          if (p) {
                            ...
                            j < e.top && (s = "rgba(0,0,0,0)"), j += o.aliasPixel(r), R = e.getPixelForTick(n) + d.labelOffset, v = P, x = I, w = t.left, S = t.right + D, b = y = M = F = j
                          }
                          _.push({
                            tx1: v,
                            ty1: b,
              ...
              t.Tooltip = a.extend({
                ...
                update: function (e) {
                  ...
                  if (p.length) {
                    ...
                    var k = [],
                      w = [];
                    y = t.Tooltip.positioners[h.position].call(c, p, c._eventPosition);
                    var M = [];
                    for (i = 0, n = p.length; i < n; ++i) M.push((a = p[i], s = void 0, l = void 0, void 0, void 0, s = a._xScale, l = a._yScale || a._scale, u = a._index, d = a._datasetIndex, {
                    ...
                    h.filter && (M = M.filter(function (t) {
                      return h.filter(t, m)
                    })), h.itemSort && (M = M.sort(function (t, e) {
                      return h.itemSort(t, e, m)
                    })), o.each(M, function (t) {
                      k.push(h.callbacks.labelColor.call(c, t, c._chart)), w.push(h.callbacks.labelTextColor.call(c, t, c._chart))
                    }), g.title = c.getTitle(M, m), g.beforeBody = c.getBeforeBody(M, m), g.body = c.getBody(M, m), g.afterBody = c.getAfterBody(M, m), g.footer = c.getFooter(M, m), g.x = Math.round(y.x), g.y = Math.round(y.y), g.caretPadding = h.caretPadding, g.labelColors = k, g.labelTextColors = w, g.dataPoints = M, b = function (t, e, i, n) {
                      var a = t.x,
                        o = t.y,
                        r = t.caretSize,
                        s = t.caretPadding,
                        ...
                        c = r + s,
                        h = l + s;
                      return "right" === u ? a -= e.width : "center" === u && ((a -= e.width / 2) + e.width > n.width && (a = n.width - e.width), a < 0 && (a = 0)), "top" === d ? o += c : o -= "bottom" === d ? e.height + c : e.height / 2, "center" === d ? "left" === u ? a += c : "right" === u && (a -= c) : "left" === u ? a -= h : "right" === u && (a += h), {
                        x: a,
                        y: o
                      }
                    }(g, x = function (t, e) {
                  ...
                  return g.xAlign = v.xAlign, g.yAlign = v.yAlign, g.x = b.x, g.y = b.y, g.width = x.width, g.height = x.height, g.caretX = y.x, g.caretY = y.y, c._model = g, e && h.custom && h.custom.call(c, g), c
                },
          ...
          50: [function (t, e, i) {
            ...
            e.exports = {
              ...
              afterDatasetsUpdate: function (t, e) {
                var i, n, o, r, c = (t.data.datasets || []).length,
                  h = e.propagate,
                  f = [];
                for (n = 0; n < c; ++n) r = null, (o = (i = t.getDatasetMeta(n)).dataset) && o._model && o instanceof a.Line && (r = {
                  visible: t.isDatasetVisible(n),
                  fill: s(o, n, c),
                  chart: t,
                  el: o
                }), i.$filler = r, f.push(r);
                for (n = 0; n < c; ++n)(r = f[n]) && (r.fill = u(f, n, h), r.boundary = l(r), r.mapper = d(r))
              },
              beforeDatasetDraw: function (t, e) {
                ...
                if (i) {
                  ...
                  u && d && l.length && (o.canvas.clipArea(a, t.chartArea), function (t, e, i, n, a, o) {
                    var r, s, l, u, d, f, g, p = e.length,
                      m = n.spanGaps,
                      v = [],
                      b = [],
                      x = 0,
                      y = 0;
                    for (t.beginPath(), r = 0, s = p + !!o; r < s; ++r) d = i(u = e[l = r % p]._view, l, n), f = c(u), g = c(d), f && g ? (x = v.push(u), y = b.push(d)) : x && y && (m ? (f && v.push(u), g && b.push(d)) : (h(t, v, b, x, y), x = y = 0, v = [], b = []));
                    h(t, v, b, x, y), t.closePath(), t.fillStyle = a, t.fill()
                  }(a, l, u, s, d, r._loop), o.canvas.unclipArea(a))
                }
              }
            }
          }, {
                ...
                if (e.display) {
                  ...
                  o.each(t.legendItems, function (n, l) {
                    var f = c.measureText(n.text).width,
                      ...
                      m = d.x,
                      v = d.y;
                    y ? m + p >= s && (v = d.y += k, d.line++, m = d.x = t.left + (s - u[d.line]) / 2) : v + k > t.bottom && (m = d.x = m + t.columnWidths[d.line] + i.padding, v = d.y = t.top + i.padding, d.line++),
                      function (t, i, n) {
                        if (!(isNaN(b) || b <= 0)) {
            ...
            e.exports = function (t) {
              ...
              var f = t.LinearScaleBase.extend({
                ...
                setReductions: function (t, e, i) {
                  ...
                  n = h(n), a = h(a), o = h(o), r = h(r), this.drawingArea = Math.min(Math.round(t - (n + a) / 2), Math.round(t - (o + r) / 2)), this.setCenterPoint(n, a, o, r)
                },
                    ...
                    a.each(t.ticks, function (i, s) {
                      if (s > 0 || o.reverse) {
                        ...
                        if (n.display && 0 !== s && function (t, e, i, n) {
                          ...
                          if (h.font = v, h.save(), h.translate(t.xCenter, t.yCenter), h.rotate(f), o.showLabelBackdrop) {
                            var c = h.measureText(i).width;
                            h.fillStyle = o.backdropColor, h.fillRect(-c / 2 - o.backdropPaddingX, -u - g / 2 - o.backdropPaddingY, c + 2 * o.backdropPaddingX, g + 2 * o.backdropPaddingY)
                          }
                      ...
                      for (var g = r(t) - 1; g >= 0; g--) {
                        ...
                        if (l.display) {
                          var m = t.getPointPosition(g, h + 5),
                            v = a.valueAtIndexOrDefault(l.fontColor, g, e.defaultFontColor);
                          i.font = f.font, i.fillStyle = v;
                          var b = t.getIndexAngle(g),
                            x = a.toDegrees(b);
                          i.textAlign = u(x), c(x, t._pointLabelSizes[g], m), d(i, t.pointLabels[g] || "", m, f.size)
                        }
                      }
                    }(t)
                  }
            ...
            e.exports = function (t) {
              var e = t.Scale.extend({
                ...
                buildTicks: function () {
                  ...
                  for ("ticks" === s.bounds && c.length && (o = c[0], r = c[c.length - 1]), o = g(d.min, a) || o, r = g(d.max, a) || r, t = 0, e = c.length; t < e; ++t)(i = c[t]) >= o && i <= r && v.push(i);
                  return a.min = o, a.max = r, a._unit = d.unit || function (t, e, i, a) {
                    ...
                    }(v, d.minUnit, a.min, a.max), a._majorUnit = p(a._unit), a._table = function (t, e, i, n) {
                    ...
                    }(a._table, v, o, r, s), a._labelFormat = function (t, e) {
