 ...
 function (E, F, O, D) {
     ...
     F = void 0 !== F && F.Math == Math ? F : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), E.fn.search = function (l) {
         ...
         error: {
             ...
             noResults: "Tìm kiếm của bạn không có khóa học hay bài viết nào!",
         ...
         templates: {
             ...
             message: function (e, t) {
                 var n = "";
                 return e !== D && t !== D && (n += '<div class="message ' + t + '">', n += "empty" == t ? '<div class="header">Không tìm thấy kết quả</div class="header"><div class="description">' + e + '</div class="description">' : ' <div class="description">' + e + "</div>", n += "</div>"), n
             },
